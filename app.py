...
def main():
    ...
    user_id = st.text_input("Enter your User ID", placeholder="0000", help="Type your unique user ID here. If unsure, use the default value.")
    ...
    if st.button("Extract and Categorize Links"):
        ...
        st.session_state.results = process(user_id=user_id, empty_links=empty_links_bool, progress=progress_bar)
